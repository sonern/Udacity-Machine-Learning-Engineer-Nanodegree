...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing==True:
            ...
            #self.epsilon = math.exp(-(self.a*self.trial_number))
            #self.epsilon = 1 - (1/(1+math.exp(-0.05*self.alpha*(self.trial_number))))
            self.epsilon = math.exp(-0.01*self.trial_number)
            self.trial_number = self.trial_number+1
        return None
